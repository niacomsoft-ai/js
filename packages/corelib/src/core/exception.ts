...
export class Exception extends Error implements sys.Exception {
	...
	constructor(...args: Array<any>) {
		super();
		if (Object.isNull(args) || args.length === 0) this.message = this.safeGetErrorMessage("", "Exception");
		else if (typeof args[0] === "string") this.message = this.safeGetErrorMessage(args[0], "Exception");
